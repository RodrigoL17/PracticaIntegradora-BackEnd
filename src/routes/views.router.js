...
router.get("/profile/:uid", viewsController.renderProfile); // Render profile
...
router.get("/products/addNewProduct/:uid", viewsController.renderAddNewProduct); // Render Add New Product
router.get(
  "/products",
